import {
  DomSanitizer
} from "./chunk-4CAJN2QI.js";
import "./chunk-UTEUF5UU.js";
...
import {
  ...
  ɵɵprojectionDef,
  ɵɵsanitizeHtml
} from "./chunk-AIEKDBKN.js";
import {
  __spreadProps,
  __spreadValues
} from "./chunk-AZQ77ADY.js";
...
FaConfig.ɵfac = function FaConfig_Factory(t2) {
  return new (t2 || FaConfig)();
};
...
FaIconLibrary.ɵfac = function FaIconLibrary_Factory(t2) {
  return new (t2 || FaIconLibrary)();
};
...
FaStackItemSizeDirective.ɵfac = function FaStackItemSizeDirective_Factory(t2) {
  return new (t2 || FaStackItemSizeDirective)();
};
...
FaStackComponent.ɵfac = function FaStackComponent_Factory(t2) {
  return new (t2 || FaStackComponent)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef));
};
...
FaIconComponent.ɵfac = function FaIconComponent_Factory(t2) {
  return new (t2 || FaIconComponent)(ɵɵdirectiveInject(DomSanitizer), ɵɵdirectiveInject(FaConfig), ɵɵdirectiveInject(FaIconLibrary), ɵɵdirectiveInject(FaStackItemSizeDirective, 8), ɵɵdirectiveInject(FaStackComponent, 8));
};
...
FaDuotoneIconComponent.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function FaDuotoneIconComponent_Factory(t2) {
    return (ɵFaDuotoneIconComponent_BaseFactory || (ɵFaDuotoneIconComponent_BaseFactory = ɵɵgetInheritedFactory(FaDuotoneIconComponent)))(t2 || FaDuotoneIconComponent);
  };
})();
...
FaLayersComponent.ɵfac = function FaLayersComponent_Factory(t2) {
  return new (t2 || FaLayersComponent)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(FaConfig));
};
...
FaLayersCounterComponent.ɵfac = function FaLayersCounterComponent_Factory(t2) {
  return new (t2 || FaLayersCounterComponent)(ɵɵdirectiveInject(FaLayersComponent, 8), ɵɵdirectiveInject(DomSanitizer));
};
...
FaLayersTextComponent.ɵfac = function FaLayersTextComponent_Factory(t2) {
  return new (t2 || FaLayersTextComponent)(ɵɵdirectiveInject(FaLayersComponent, 8), ɵɵdirectiveInject(DomSanitizer));
};
...
FontAwesomeModule.ɵfac = function FontAwesomeModule_Factory(t2) {
  return new (t2 || FontAwesomeModule)();
};
